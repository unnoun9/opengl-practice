...
test::texture_2d::texture_2d(const int window_width, const int window_height)
...
void test::texture_2d::on_render()
{
...
void test::texture_2d::on_imgui_render()
{
